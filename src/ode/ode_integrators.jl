...
function ode_euler(f::Function,u,t,Δt,T,iter,maxiters,
                    timeseries,ts,timeseries_steps,save_timeseries,adaptive,progressbar,atomloaded,progress_steps)
  while t < T
    @ode_loopheader
    u = u + Δt.*f(u,t)
    @ode_loopfooter
...
function ode_midpoint(f::Function,u::Number,t,Δt,T,iter,
                      maxiters,timeseries,ts,timeseries_steps,save_timeseries,adaptive,progressbar,atomloaded,progress_steps)
  halfΔt = Δt/2
  while t < T
    @ode_loopheader
...
function ode_rk4(f::Function,u::AbstractArray,t,Δt,T,
                iter,maxiters,timeseries,ts,timeseries_steps,save_timeseries,adaptive,progressbar,atomloaded,progress_steps)
  halfΔt = Δt/2
  k₁ = similar(u)
  k₂ = similar(u)
  k₃ = similar(u)
...
function ode_explicitrk(f::Function,u::Number,t,Δt,T,iter,maxiters,timeseries,ts,
                        ...
                        abstol,reltol,qmax,Δtmax,Δtmin,internalnorm,progressbar,atomloaded,progress_steps)
...
function ode_feagin10(f::Function,u,t,Δt,T,iter,order,
                        maxiters,timeseries,ts,timeseries_steps,save_timeseries,
                        γ,adaptive,abstol,reltol,qmax,Δtmax,Δtmin,internalnorm,progressbar,atomloaded,progress_steps)
...
function ode_impliciteuler(f::Function,u,t,Δt,T,iter,maxiters,
                            timeseries,ts,timeseries_steps,save_timeseries,adaptive,sizeu,progressbar,atomloaded,progress_steps,autodiff)
...
function ode_rosenbrock32(f::Function,u::AbstractArray,t,Δt,T,iter,
                          ...
                          sizeu,abstol,reltol,qmax,Δtmax,Δtmin,internalnorm,progressbar,atomloaded,progress_steps,γ)
  order = 2
  c₃₂ = 6 + sqrt(2)
  d = 1/(2+sqrt(2))
  k₁ = similar(u)
